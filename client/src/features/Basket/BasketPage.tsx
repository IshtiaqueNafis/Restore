...
const BasketPage = () => {
    ...
    function handleAddItem(productId: number, name: string) {
        ...
        agent.Basket.addItem(productId).then(basket => setBasket(basket)).catch(error => console.log(error)).finally(() => setStatus({
            loading: false,
            name: ''
        }));
    }
    ...
    function handleRemoveItem(productId: number, quantity: number = 1,name:string) {
        ...
        agent.Basket.removeItem(productId, quantity).then(() => removeItem(productId, quantity)).catch(error => console.log(error)).finally(() => setStatus({
            loading: false,
            name: ''
        }));
    }
